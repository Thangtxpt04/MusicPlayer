...
const app = {
    ...
    songs: [
        ...
        },
        {
            ...
            singer: "Hồ Quốc Việt",
            path: "./assets/music/DonGianAnhYeuEm-HoQuocViet-4412589.mp3",
            img: "./assets/img/dongiananhyeuem.jpg"
        },
        {
        ...
        },
        {
            name: "Hà Nội n U",
            singer: "Đinh Đức Anh",
            path: "./assets/music/Hanoinu.mp3",
            img: "./assets/img/hanoinu.jpg"
        },
        {
            name: "Mặt Mộc",
    ...
    render : function()
    {
        var htmls = this.songs.map((song,index) =>{
            return `
            <div class="playlist-item ${this.currentIndex === index ? 'active' : ''}" data-index = ${index}>
